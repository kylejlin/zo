...
// @sha256 50766c33d05949c75b8f56212dae944ae15c2327b1a2f4a295e36411ebd5367e
...
fn pop_and_reduce(states: &mut Vec<State>, nodes: &mut Vec<Node>, rule_kind: RuleKind) -> (Node, NonterminalKind) {
    match rule_kind {
        ...
        RuleKind::R36 => {
            ...
            (
                Node::ReturnArityClause(ReturnArityClause::Named(
                    t0,
                )),
...
const GOTO_TABLE: [[Option<State>; 36]; 113] = [
    [
        Some(State::S27),
        Some(State::S8),
        Some(State::S16),
