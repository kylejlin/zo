...
// @sha256 3f77af8f01277ad179fdeab3c552954fa1a4b8abc7d9834243e48316d9ea6abd
...
enum NonterminalKind {
    ...
    UseClause = 21,
    UseClauseDefs = 22,
    SquareBracketedCommaSeparatedIdentsOrUnderscores = 23,
    CommaSeparatedIdentsOrUnderscores = 24,
    ZeroOrMoreMatchCases = 25,
    MatchCase = 26,
    OptParenthesizedCommaSeparatedIdentsOrUnderscores = 27,
    ParenthesizedCommaSeparatedIdentsOrUnderscores = 28,
    Afun = 29,
    OptIdent = 30,
    App = 31,
    VarOrApp = 32,
    CommaSeparatedExprs = 33,
    For = 34,
...
const ACTION_TABLE: [[Action; 26]; 112] = [
    [
        Action::Err,
        Action::Err,
        Action::Err,
...
const GOTO_TABLE: [[Option<State>; 36]; 112] = [
    [
        Some(State::S27),
        Some(State::S8),
        Some(State::S16),
