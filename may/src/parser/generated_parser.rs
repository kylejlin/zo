...
// @sha256 bc88fe43a782c31114ec42321240dbccf1d553a77a1ed74fda4225c4524f7db7
...
enum NonterminalKind {
    ...
    IndCase = 12,
    OptColonSquareBracketedExprs = 13,
    Fun = 14,
    FunCommonInnards = 15,
    Aind = 16,
    Vcon = 17,
...
const ACTION_TABLE: [[Action; 26]; 110] = [
    [
        Action::Err,
        Action::Err,
        Action::Err,
...
const GOTO_TABLE: [[Option<State>; 35]; 110] = [
    [
        Some(State::S27),
        Some(State::S8),
        Some(State::S16),
