...
fn pop_and_reduce(states: &mut Vec<State>, nodes: &mut Vec<Node>, rule_kind: RuleKind) -> (Node, NonterminalKind) {
    match rule_kind {
        ...
        RuleKind::R8 => {
            ...
            let letkw_0 = nodes.pop().unwrap().try_into_let_kw_11().ok().unwrap();
...
const ACTION_TABLE: [[Action; 26]; 119] = [
    [
        Action::Err,
        Action::Err,
        Action::Err,
        ...
        Action::Shift(State::S107),
        Action::Shift(State::S40),
        Action::Err,
        Action::Err,
        Action::Err,
        Action::Err,
        Action::Shift(State::S112),
        Action::Err,
        Action::Err,
...
const GOTO_TABLE: [[Option<State>; 36]; 119] = [
    [
        Some(State::S26),
        Some(State::S7),
        Some(State::S17),
