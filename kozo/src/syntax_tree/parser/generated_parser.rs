...
// @sha256 59ae322dd1d3085c87cc56856764e552cb08300a0a422a8b447684e5410d3e55
...
pub enum Token {
    ...
    RetypeKw(crate::syntax_tree::token::ByteIndex),
    ...
    Rewrite(crate::syntax_tree::token::RewriteLiteral),
...
pub struct Match {
    ...
    pub econ_extension_len: crate::syntax_tree::token::NumberLiteral,
...
pub struct Retype {
    pub lparen: crate::syntax_tree::token::ByteIndex,
    pub in_term: Box<Expr>,
    pub in_type: Box<Expr>,
    pub out_type: Box<Expr>,
    pub in_rewrites_lparen: crate::syntax_tree::token::ByteIndex,
    pub in_rewrites: Box<ZeroOrMoreRewrites>,
    pub in_rewrites_rparen: crate::syntax_tree::token::ByteIndex,
    pub out_rewrites_lparen: crate::syntax_tree::token::ByteIndex,
    pub out_rewrites: Box<ZeroOrMoreRewrites>,
    pub out_rewrites_rparen: crate::syntax_tree::token::ByteIndex,
    pub rparen: crate::syntax_tree::token::ByteIndex,
}

#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub enum ZeroOrMoreRewrites {
    Nil,
    Snoc(
        Box<ZeroOrMoreRewrites>,
        crate::syntax_tree::token::RewriteLiteral,
    ),
}
...
enum Node {
    ...
    Retype(Retype),
    ZeroOrMoreRewrites(ZeroOrMoreRewrites),
    Fun(Fun),
...
fn pop_and_reduce(states: &mut Vec<State>, nodes: &mut Vec<Node>, rule_kind: RuleKind) -> (Node, NonterminalKind) {
    match rule_kind {
        ...
        RuleKind::R3 => {
            let t0 = Box::new(Retype::try_from(nodes.pop().unwrap()).ok().unwrap());
            
            states.truncate(states.len() - 1);
            
            (
                Node::Expr(Expr::Retype(
                    t0,
                )),
                NonterminalKind::Expr,
            )
        ...
        RuleKind::R7 => {
            let t0 = nodes.pop().unwrap().try_into_number_10().ok().unwrap();
        ...
        RuleKind::R8 => {
            let t0 = nodes.pop().unwrap().try_into_universe_13().ok().unwrap();
        ...
        RuleKind::R9 => {
            ...
            let name_3 = nodes.pop().unwrap().try_into_string_11().ok().unwrap();
            let type__2 = nodes.pop().unwrap().try_into_universe_13().ok().unwrap();
            nodes.pop().unwrap();
        ...
        RuleKind::R15 => {
            ...
            let vcon_index_3 = nodes.pop().unwrap().try_into_number_10().ok().unwrap();
        ...
        RuleKind::R16 => {
            ...
            let econ_extension_len_3 = nodes.pop().unwrap().try_into_number_10().ok().unwrap();
            ...
            (
                Node::Match(Match {
                    lparen: lparen_0,
                    matchee: matchee_2,
                    econ_extension_len: econ_extension_len_3,
        ...
        RuleKind::R20 => {
            let t0 = nodes.pop().unwrap().try_into_contra_kw_9().ok().unwrap();
        ...
        RuleKind::R21 => {
            ...
            let arity_1 = nodes.pop().unwrap().try_into_number_10().ok().unwrap();
            let lparen_0 = nodes.pop().unwrap().try_into_l_paren_0().ok().unwrap();
        ...
        RuleKind::R22 => {
            let rparen_11 = nodes.pop().unwrap().try_into_r_paren_1().ok().unwrap();
            let out_rewrites_rparen_10 = nodes.pop().unwrap().try_into_r_paren_1().ok().unwrap();
            let out_rewrites_9 = Box::new(ZeroOrMoreRewrites::try_from(nodes.pop().unwrap()).ok().unwrap());
            let out_rewrites_lparen_8 = nodes.pop().unwrap().try_into_l_paren_0().ok().unwrap();
            let in_rewrites_rparen_7 = nodes.pop().unwrap().try_into_r_paren_1().ok().unwrap();
            let in_rewrites_6 = Box::new(ZeroOrMoreRewrites::try_from(nodes.pop().unwrap()).ok().unwrap());
            let in_rewrites_lparen_5 = nodes.pop().unwrap().try_into_l_paren_0().ok().unwrap();
            let out_type_4 = Box::new(Expr::try_from(nodes.pop().unwrap()).ok().unwrap());
            let in_type_3 = Box::new(Expr::try_from(nodes.pop().unwrap()).ok().unwrap());
            let in_term_2 = Box::new(Expr::try_from(nodes.pop().unwrap()).ok().unwrap());
            nodes.pop().unwrap();
            let lparen_0 = nodes.pop().unwrap().try_into_l_paren_0().ok().unwrap();
            
            states.truncate(states.len() - 12);
            ...
            (
                Node::Retype(Retype {
                    ...
                    in_type: in_type_3,
                    out_type: out_type_4,
                    in_rewrites_lparen: in_rewrites_lparen_5,
                    in_rewrites: in_rewrites_6,
                    in_rewrites_rparen: in_rewrites_rparen_7,
                    out_rewrites_lparen: out_rewrites_lparen_8,
                    out_rewrites: out_rewrites_9,
                    out_rewrites_rparen: out_rewrites_rparen_10,
                    rparen: rparen_11,
                }),
                NonterminalKind::Retype,
            )
        }
        RuleKind::R23 => {
            (
                Node::ZeroOrMoreRewrites(ZeroOrMoreRewrites::Nil),
                NonterminalKind::ZeroOrMoreRewrites,
            )
        }
        RuleKind::R24 => {
            let t1 = nodes.pop().unwrap().try_into_rewrite_12().ok().unwrap();
            let t0 = Box::new(ZeroOrMoreRewrites::try_from(nodes.pop().unwrap()).ok().unwrap());
            
            states.truncate(states.len() - 2);
            
            (
                Node::ZeroOrMoreRewrites(ZeroOrMoreRewrites::Snoc(
                    t0,
                    t1,
                )),
                NonterminalKind::ZeroOrMoreRewrites,
        ...
        RuleKind::R27 => {
            let t0 = nodes.pop().unwrap().try_into_nonrec_kw_8().ok().unwrap();
...
impl QuasiterminalKind {
    ...
    fn from_terminal(terminal: &Token) -> Self {
        match terminal {
            ...
            Token::RetypeKw(_) => Self::RetypeKw,
...
impl Node {
    fn from_terminal(terminal: Token) -> Self {
        match terminal {
            ...
            Token::RetypeKw(t) => Self::RetypeKw(t),
            ...
            Token::Rewrite(t) => Self::Rewrite(t),
...
const ACTION_TABLE: [[Action; 15]; 83] = [
    [
...
const GOTO_TABLE: [[Option<State>; 16]; 83] = [
    [
        Some(State::S40),
        Some(State::S12),
        None,
...
impl TryFrom<Node> for ZeroOrMoreRewrites {
    type Error = Node;

    fn try_from(node: Node) -> Result<Self, Self::Error> {
        match node {
            Node::ZeroOrMoreRewrites(n) => Ok(n),
            _ => Err(node),
        }
    }
}
...
impl Node {
    ...
    fn try_into_retype_kw_5(self) -> Result<crate::syntax_tree::token::ByteIndex, Self> {
        match self {
            Self::RetypeKw(t) => Ok(t),
            _ => Err(self),
        }
    }
    
    fn try_into_fun_kw_6(self) -> Result<crate::syntax_tree::token::ByteIndex, Self> {
        match self {
            Self::FunKw(t) => Ok(t),
            _ => Err(self),
        }
    ...
    fn try_into_for_kw_7(self) -> Result<crate::syntax_tree::token::ByteIndex, Self> {
        match self {
            Self::ForKw(t) => Ok(t),
            _ => Err(self),
        }
    ...
    fn try_into_nonrec_kw_8(self) -> Result<crate::syntax_tree::token::ByteIndex, Self> {
        match self {
    ...
    fn try_into_contra_kw_9(self) -> Result<crate::syntax_tree::token::ByteIndex, Self> {
        match self {
    ...
    fn try_into_number_10(self) -> Result<crate::syntax_tree::token::NumberLiteral, Self> {
        match self {
            Self::Number(t) => Ok(t),
            _ => Err(self),
        }
    ...
    fn try_into_string_11(self) -> Result<crate::syntax_tree::token::StringLiteral, Self> {
        match self {
            Self::String(t) => Ok(t),
            _ => Err(self),
        }
    ...
    fn try_into_rewrite_12(self) -> Result<crate::syntax_tree::token::RewriteLiteral, Self> {
        match self {
            Self::Rewrite(t) => Ok(t),
            _ => Err(self),
        }
    ...
    fn try_into_universe_13(self) -> Result<crate::syntax_tree::token::UniverseLiteral, Self> {
        match self {
